...
GRANT USAGE, SELECT ON SEQUENCE applications_id_seq TO service_role;
GRANT USAGE, SELECT ON SEQUENCE saved_jobs_id_seq TO service_role;
GRANT USAGE, SELECT ON SEQUENCE ai_chat_history_id_seq TO service_role;
GRANT USAGE, SELECT ON SEQUENCE user_preferences_id_seq TO service_role;
